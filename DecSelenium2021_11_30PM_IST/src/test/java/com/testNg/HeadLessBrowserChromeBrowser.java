...
public class HeadLessBrowserChromeBrowser extends library_BusinessFunctions{
	//HtmlUnitDriver driver;
	public static WebDriver driver ;
	@Test(priority = 0)
	public void testingHeadlessUsingChromeBrowser() throws IOException{
		ReadPropertyFile();
	...
	@Test(priority = 1, dependsOnMethods = { "testingHeadlessUsingChromeBrowser" })
